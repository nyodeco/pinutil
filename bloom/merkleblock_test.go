...
func TestMerkleBlock3(t *testing.T) {
	...
	blk, err := pinutil.NewBlockFromBytes(blockBytes)
	if err != nil {
	...
	err = mBlock.PinEncode(got, wire.ProtocolVersion, wire.LatestEncoding)
	if err != nil {
		t.Errorf("TestMerkleBlock3 PinEncode failed: %v", err)
		return
	}
