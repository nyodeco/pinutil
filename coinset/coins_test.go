...
import (
	...
	"github.com/nyodeco/pinutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    pinutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() pinutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value pinutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = pinutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = pinutil.NewTxFromBytes(testSimpleCoinTxBytes)
