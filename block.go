...
// Tx returns a wrapped transaction (pinutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (pinutil.Tx) for all
...
// instead provides easy access to wrapped versions (pinutil.Tx) of them.
